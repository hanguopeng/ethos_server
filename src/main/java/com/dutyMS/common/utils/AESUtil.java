...
public class AESUtil {
	...
	public static String encyrpt(String text) {
		...
		byte[] encodedText = encodeAesEcb(text.getBytes(), key);
...
//    }
	 ...
	 * @return
	 */
	public static byte[] encodeAesEcb(byte[] plainText, SecretKey key) {
	 ...
	 * @return
	 */
	public static String decodeAesEcb(byte[] decodedText, SecretKey key) {
		try {
			Cipher cipher = Cipher.getInstance(ECB_CIPHER_ALGORITHM);
	 ...
	 * @return
	 */
	public static byte[] encodeAesCbc(byte[] plainText, SecretKey key, byte[] ivParameter) {
		try {
	 ...
	 * @return
	 */
	public static String decodeAesCbc(byte[] decodedText, SecretKey key, byte[] ivParameter) {
		IvParameterSpec ivParameterSpec = new IvParameterSpec(ivParameter);
